...
public class CustomAdapter extends ArrayAdapter<com.example.mychatapptutorial.ContactModel> {

    Context context;
    List<com.example.mychatapptutorial.ContactModel> contacts;

    public CustomAdapter(@NonNull Context context, List<com.example.mychatapptutorial.ContactModel> contacts) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.example.mychatapptutorial.ContactModel c = getItem(position);
    ...
    public void refresh(List<com.example.mychatapptutorial.ContactModel> list) {
        contacts.clear();
