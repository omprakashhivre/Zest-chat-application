...
import com.example.mychatapptutorial.ContactModel;
import com.example.mychatapptutorial.CustomAdapter;
import com.example.mychatapptutorial.DbHelper;
import com.example.mychatapptutorial.ReactivateService;
import com.example.mychatapptutorial.SensorService;
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (db.count() != 5) {
                    ...
                    Toast.makeText(SosActivity.this, "Can't Add more than 5 Contacts", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
