...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void addcontact(com.example.mychatapptutorial.ContactModel contact){
    ...
    public List<com.example.mychatapptutorial.ContactModel> getAllContacts(){
        List<com.example.mychatapptutorial.ContactModel> list=new ArrayList<>();
        ...
        if(c.moveToFirst()) {
            do {
                ...
                list.add(new com.example.mychatapptutorial.ContactModel(c.getInt(0),c.getString(1),c.getString(2)));
    ...
    public void deleteContact(com.example.mychatapptutorial.ContactModel contact) {
        SQLiteDatabase db = this.getWritableDatabase();
